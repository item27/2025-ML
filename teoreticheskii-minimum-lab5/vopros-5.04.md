...
> Карта признаков (feature map). Как рассчитывается, является ли слоем, какие признаки хранит на разных слоях сети, разное ли количество карт признаков в разных слоях

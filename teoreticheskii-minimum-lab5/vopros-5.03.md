...
> Как операция свертки меняет размер изображения? От каких параметров зависит то, насколько изображение станет меньше? Что такое padding и stride в свертке? Неплохая [визуализация](https://proglib.io/p/convolution)

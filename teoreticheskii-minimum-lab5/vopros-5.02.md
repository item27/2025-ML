...
> Что такое сверточный слой с точки зрения глубокого обучения. Какие гиперпараметры, на что они влияют, как слой обучается, какие признаки извлекает на каком слое сверточной сети
